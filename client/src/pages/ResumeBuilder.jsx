...
import { ArrowLeftIcon, FolderIcon, GraduationCap, Sparkles, User, FileText, Briefcase, ChevronLeft } from 'lucide-react'
...
const ResumeBuilder = () => {
    ...
    const activateSection = section[activeSectionIndex]
            ...
            <div className='grid lg:grid-cols-12 gap-8'>
                ...
                <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>  
                   ...
                   <hr className='absolute top-0 left-0 right-0 border-2 border-gray-200' />
                     ...
                     items-center mb-6 border-b border-gray-300 py-1'>
                    ...
                    {(template)=> setResumeData(prev => ({...prev, template}))}/>
                     ...
                     <div className='flex items-center'>
                        ...
                        <button onClick={()=>setActiveSectionIndex((prevIndex)=>Math.min(prevIndex + 1, section.length - 1))} className='flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all' disabled={activeSectionIndex === section.length - 1}>
