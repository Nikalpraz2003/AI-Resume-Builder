...
<div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-green-200 rounded-full px-6 py-1">
        ...
        <Title title='Build your resume'  />
            ...
            `}</style>
            <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">Our streamlined process helps you create a professional resume in minutes with our easy-to-use builder and AI-powered tools with advanced  features.</p>
